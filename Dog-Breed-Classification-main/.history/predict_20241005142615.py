...
def load_confusion_matrix():
    ...
    confusion_image = confusion_image.resize((500, 300))
    result_image = result_image.resize((500, 300))
...
def predict_image(file_path):
    try:
        ...
        # พิมพ์ข้อมูลของผลลัพธ์เพื่อตรวจสอบพาธ
        ...
        predicted_image = predicted_image.resize((500, 300))
